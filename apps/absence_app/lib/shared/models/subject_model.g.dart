...
SubjectModel _$SubjectModelFromJson(Map<String, dynamic> json) => SubjectModel(
  ...
  currentAbsences: (json['currentAbsences'] as num?)?.toInt() ?? 0,
  absencePercentage: (json['absencePercentage'] as num?)?.toDouble() ?? 0.0,
  remainingAbsences: (json['remainingAbsences'] as num?)?.toInt() ?? 0,
...
Map<String, dynamic> _$SubjectModelToJson(SubjectModel instance) =>
    <String, dynamic>{
      ...
      'remainingAbsences': instance.remainingAbsences,
